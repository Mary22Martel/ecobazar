...
<div class="flex justify-center items-center min-h-screen bg-gray-100">
    <div class="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-lg">
        <h2 class="text-center text-3xl font-bold text-gray-900">Registro de Agricultor</h2>

        <form method="POST" action="{{ route('agricultor.register.submit') }}" class="space-y-6">
            @csrf
