...
@section('content')
<div class="px-4 py-6">
  <h1 class="text-2xl font-semibold mb-4">Editar Mercado</h1>
  ...
  <form action="{{ route('admin.mercados.update', $mercado) }}"
        method="POST"
    ...
    <div>
      ...
      <input type="text" name="nombre" id="nombre"
             value="{{ old('nombre', $mercado->nombre) }}"
             required
